...
export function Footer() {
  ...
  <a
    ...
    className="transition-all duration-200 group-hover:text-orange-400 group-hover:underline"
  >
  ...
  {[
    ...
    { name: "LinkedIn", icon: Linkedin, link: "https://linkedin.com/in/prateek-yadav-2616a6257" },
    { name: "Twitter", icon: Twitter, link: "https://twitter.com" },
    { name: "Instagram", icon: Instagram, link: "https://www.instagram.com/prateek___yadav____/" },
    { name: "Email", icon: Mail, link: "mailto:prateek246729@gmail.com" },
  ].map((item, i) => (
    <div key={i} className="relative group">
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="w-11 h-11 rounded-full bg-secondary/50 border border-border
      ...
      <span
        ...
        bg-popover text-popover-foreground text-xs px-3 py-1 rounded-md
