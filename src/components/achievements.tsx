...
import {
  Award,
  Bot, ClipboardCheck, Code2,
  ExternalLink, GitBranch, Medal, Network, Terminal, Trophy
} from "lucide-react"
...
const achievements = [
  {
    ...
    link: "https://drive.google.com/file/d/1Bq-6Ger9KoNUXb3AZtb23esifpWshfBX/view?usp=sharing",
  },
  {
    Icon: Award,
    ...
    link: "https://drive.google.com/file/d/14D8uQVB204rlN0IN3qT2cFTkpBH44QJ_/view?usp=sharing",
  },
  {
    Icon: Bot,
    stat: "NPTEL",
    ...
    link: "https://drive.google.com/file/d/1JDtC3x93Z539WpHD83Y3LWzvYf8pfGan/view?usp=sharing",
  },
  {
  Icon: Code2,
  stat: "Oracle",
  ...
  link: "https://drive.google.com/file/d/11fz_n1VGpR_dBxPOg9urL1h6RrrbNQOi/view?usp=sharing",
},
{
  Icon: Terminal,
  stat: "Hacker Rank",
  ...
  link: "https://drive.google.com/file/d/1wqZKZ9fHyL37pU2xOngxpZa7Ay27OhDs/view?usp=sharing",
},
  {
    Icon: Medal,
    stat: "Infosys",
    ...
    link: "https://drive.google.com/file/d/1Jusu2wV3H8aBi83oa0SluCKCnB0Ivmxq/view?usp=sharing",
  },
  {
  Icon: GitBranch,
  stat: "Microsoft",
  ...
  link: "https://drive.google.com/file/d/1uf09EBYQwk501Un5ngQAMT24_ftpqNxQ/view?usp=sharing",
},
{
  Icon: Network,
  stat: "Physics Wallah",
  ...
  link: "https://drive.google.com/file/d/1kKFPFId4Zd7jfdHYxhm-KXrlF7cvuWiR/view?usp=sharing",
},  
{
  Icon: ClipboardCheck,
  stat: "Qualified",
  ...
  link: "https://drive.google.com/file/d/1hL0mZrVBGxDSJSdbSFCPJR8RKkNVpdp9/view?usp=sharing",
},
]
  ...
  return (
    <section id="achievements" ref={ref} className="py-24 px-4">
      <div className="container mx-auto max-w-7xl">
            ...
            >
              ...
              >
                ...
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div
                    className={`text-xl font-bold text-transparent bg-gradient-to-r ${item.gradient} bg-clip-text`}
                  >
                    {item.stat}
                  </div>
                </div>
                ...
                {/* Hover overlay */}
                <div
                  className={`absolute inset-0 rounded-lg bg-gradient-to-r ${item.gradient}
        ...
        {/* ===== Stats ===== */}
        <div className="mt-20 bg-gradient-to-br from-secondary/80 to-secondary/40
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <Stat value="20+" label="Technologies" gradient="from-blue-400 to-blue-500" />
...
function Stat({
  ...
  return (
    <div className="space-y-2">
      <div className={`text-3xl font-bold text-transparent bg-gradient-to-r ${gradient} bg-clip-text`}>
        {value}
      </div>
